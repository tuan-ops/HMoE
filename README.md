...
tokens_per_sec   | 31186     | 39070     | -7884     | hmoe
peak_vram_mb     | 1011      | 931       | 80        | hmoe
...
## Một số lưu ý khi phân tích kết quả
...
### 3. Usage không phải xác suất mềm

- `mean_probs`: xác suất mềm trung bình của router.
- `usage`: tỉ lệ token thực tế được chọn sau `top_k`/`top_p`.
